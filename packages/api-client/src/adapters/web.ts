import type { AuthStateManager, ErrorHandler, HttpClient, PlatformAdapter, RequestOptions } from "../types";
...
export class WebErrorHandler implements ErrorHandler {
	handleError(error: Error, context: string, _retryFn?: () => Promise<unknown>): void {
