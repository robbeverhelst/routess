...
import { DOCS_HOST, REPO_URL, SELF_HOST } from "@/lib/i18n";
...
export async function generateMetadata(): Promise<Metadata> {
	...
	return {
		...
		alternates: {
			canonical: `https://${selfHost}/developers`,
		},
	};
}
				...
				<div className="container-x">
					...
					>
						...
						<div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
							...
							<a className="btn" href={`https://${DOCS_HOST}`} style={{ background: "var(--indigo)", color: "white" }}>
								{dict.dev.hero.ctaDocs} <ArrowIcon />
							</a>
						</div>
					</div>
