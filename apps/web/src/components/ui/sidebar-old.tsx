...
export function Sidebar({
	...
	return (
		<>
						...
						{hasRoute ? (
							<div className="px-6 py-5 bg-blue-50 dark:bg-blue-950/20">
								...
								<div className="flex items-center gap-4 text-sm">
									<span className="text-gray-700 dark:text-gray-300 font-medium">{routeDistance}</span>
							...
							<div className="space-y-3">
								...
								{displayedShareUrl ? (
									<div className="mt-3 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
										<div className="text-sm font-medium mb-2">{t("sidebar.shareableLink", currentLanguage)}</div>
										<input
											type="text"
											readOnly
										...
										<div className="flex items-center gap-2">
											...
											<Button variant="ghost" size="icon" onClick={onClearShareDisplay} className="p-1.5 h-9 w-9">
												<X size={16} />
											</Button>
										</div>
									</div>
								...
								>
									...
									<div
										className={`w-9 h-5 rounded-full transition-colors ${
											showSunDirection ? "bg-blue-600 dark:bg-blue-500" : "bg-gray-300 dark:bg-gray-600"
										}`}
									>
										<div
						...
						<div className="px-6 py-5">
							...
							{isLoggedIn ? (
								...
								<div className="space-y-3">
									...
									<div className="text-center text-xs text-gray-500">{t("sidebar.signInToSave", currentLanguage)}</div>
								</div>
							)}
						</div>
			...
			{/* Settings Modal */}
			<Suspense fallback={<div className="flex items-center justify-center p-4">Loading settings...</div>}>
				<SettingsModal
