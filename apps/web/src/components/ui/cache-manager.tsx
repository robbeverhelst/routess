        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <Card className="p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 gap-2">
              ...
              >
                {isOnline
                  ? t("cacheManager.online", currentLanguage)
                  : t("cacheManager.offline", currentLanguage)}
              </span>
            </div>
            {isOnline && (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 text-sm">
                  <div>
                    <span className="font-medium">
                      {t("cacheManager.totalSize", currentLanguage)}:{" "}
                    </span>
                    <span>{formatCacheSize(getTotalCacheSize())}</span>
                  </div>
                  <div>
                    <span className="font-medium">
                      {t("cacheManager.totalEntries", currentLanguage)}:{" "}
                    </span>
