...
import { checkVersionChange, formatVersion, getStoredVersionInfo, getVersionDisplay } from "@/lib/version";
							...
							<div className="space-y-6">
								...
								<div>
									<label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
										...
										/>
										<div>
											<div className="text-sm font-medium text-gray-900 dark:text-white">Sun Direction Indicator</div>
									...
									<label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
										...
										<div>
											<div className="text-sm font-medium text-gray-900 dark:text-white">
												Error Notifications
												{isDev() && <span className="text-xs text-blue-600 dark:text-blue-400 ml-2">(Dev mode)</span>}
											</div>
											<div className="text-xs text-gray-500 mt-1">
							...
							<div>
								...
								<div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-3">
									...
									<div>
										...
										<div className="text-sm text-gray-700 dark:text-gray-300">{currentUser.email || "No email"}</div>
									</div>
							...
							<div className="space-y-6">
								...
								<div>
									...
									<div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
										<div className="text-sm font-medium text-gray-900 dark:text-white">{getVersionDisplay()}</div>
										{(() => {
								...
								{/* Developer */}
								<div>
									<h3 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Developer</h3>
									<div className="space-y-3">
										<p className="text-sm text-gray-600 dark:text-gray-400">
											Created by <span className="font-medium text-gray-900 dark:text-white">robbeverhelst</span>
										</p>
