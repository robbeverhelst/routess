      ...
      <Sheet>
        ...
        <SheetContent className="p-0 w-[280px] border-l" hideCloseButton>
              ...
              <div className="px-4 py-4 pr-10">
                <div className="flex items-center justify-between mb-1">
                  <h3 className="text-base font-medium flex items-center">
                    ...
                    {isLocked && (
                      <Lock size={14} className="ml-2 text-yellow-600 dark:text-yellow-500" />
                    )}
                  </h3>
                  <div
                    className={`text-xs px-2 py-0.5 rounded-full ${isLocked ? "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-500" : "bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400"}`}
                  >
                    {isLocked
                      ? t("sidebar.locked", currentLanguage)
                      : t("sidebar.active", currentLanguage)}
                  </div>
                </div>
          ...
          <div className="px-4 overflow-y-auto max-h-[calc(100vh-100px)]">
            ...
            <div className="mt-6">
              <div className="text-sm font-medium text-gray-500 mb-2">
                {t("sidebar.filesAndSharing", currentLanguage)}
              </div>
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      {t("sidebar.saveAsGpx", currentLanguage)}
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      {t("sidebar.fromGpx", currentLanguage)}
                    </div>
                  </div>
                </div>
                ...
                {displayedShareUrl ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">
                        {t("sidebar.createShareableLink", currentLanguage)}
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <PopoverTrigger asChild>
                    ...
                    >
                      <selectedLanguageDetails.icon
                        title={selectedLanguageDetails.name}
                        className="h-4 w-4"
                      />
                    </Button>
                  </PopoverTrigger>
