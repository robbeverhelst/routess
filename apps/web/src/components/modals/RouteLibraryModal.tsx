import { Calendar, Edit, Library, Loader2, MoreVertical, Play, Route, Search, Trash2 } from "lucide-react";
								...
								<div key={route.id} className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
									<div className="flex items-start justify-between">
										<div className="flex-1 min-w-0">
											...
											{route.description && (
												<p className="text-sm text-muted-foreground mb-2 line-clamp-2">{route.description}</p>
											)}
